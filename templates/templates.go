...
func indexTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "index.tmpl", size: 4036, mode: os.FileMode(436), modTime: time.Unix(1486974991, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
